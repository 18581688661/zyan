      ...
      <form method="POST" action="{{ route('company.update',$company->id) }}">
        {{ method_field('PATCH') }}
          ...
          <div class="form-group">
            ...
            <input type="text" name="company_account" class="form-control" value="{{ $company->company_account }}">
          </div>
          ...
          <div class="form-group">
            ...
            <input type="textarea" name="company_introduction" class="form-control" value="{{ $company->company_introduction }}">
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" name="postalcode" class="form-control" value="{{ $company->postalcode }}">
          </div>

          <div class="form-group">
            <label for="business_licence">营业执照注册号：</label>
            <input type="text" name="business_licence" class="form-control" value="{{ $company->business_licence }}">
          </div>

          <div class="form-group">
            <label for="organization_code">组织机构代码：</label>
            <input type="text" name="organization_code" class="form-control" value="{{ $company->organization_code }}">
          </div>
